...
public class JNITableSpecTest extends TestCase {
    ...
    public static Collection<Object[]> parameters() {
        ...
        return Arrays.asList(
                ...
                new Object[]{new TableSpec(), new TableSpec(), new Table(), new ColumnTypeData(RealmFieldType.MIXED)},
                new Object[]{new TableSpec(), new TableSpec(), new Table(), new ColumnTypeData(RealmFieldType.TABLE)}
        );
    }
    ...
    public void testShouldHandleColumnsDynamically() {
        ...
        table.addColumn(RealmFieldType.MIXED, "7");
        table.add(77, 77.7f, -77.7, true, "77", date, new byte[]{7, 7}, "mix");
        table.addColumn(RealmFieldType.TABLE, "8");
