...
public class JNITableSpecTest extends TestCase {
    ...
    public static Collection<Object[]> parameters() {
        ...
        return Arrays.asList(
                new Object[]{new TableSpec(), new TableSpec(), new Table(), new ColumnTypeData(RealmType.INTEGER)},
                new Object[]{new TableSpec(), new TableSpec(), new Table(), new ColumnTypeData(RealmType.FLOAT)},
                new Object[]{new TableSpec(), new TableSpec(), new Table(), new ColumnTypeData(RealmType.DOUBLE)},
                new Object[]{new TableSpec(), new TableSpec(), new Table(), new ColumnTypeData(RealmType.BOOLEAN)},
                new Object[]{new TableSpec(), new TableSpec(), new Table(), new ColumnTypeData(RealmType.STRING)},
                new Object[]{new TableSpec(), new TableSpec(), new Table(), new ColumnTypeData(RealmType.BINARY)},
                new Object[]{new TableSpec(), new TableSpec(), new Table(), new ColumnTypeData(RealmType.MIXED)},
                new Object[]{new TableSpec(), new TableSpec(), new Table(), new ColumnTypeData(RealmType.TABLE)}
        );
    }
    ...
    public void testShouldHandleColumnsDynamically() {
        table.addColumn(RealmType.INTEGER, "0");
        assertEquals(1, table.getColumnCount());
        assertEquals(0, table.getColumnIndex("0"));
        assertEquals("0", table.getColumnName(0));
        assertEquals(RealmType.INTEGER, table.getColumnType(0));
        table.add(23);

        table.addColumn(RealmType.FLOAT, "1");
        table.add(11, 11.1f);
        table.addColumn(RealmType.DOUBLE, "2");
        table.add(22, 22.2f, -22.2);
        table.addColumn(RealmType.BOOLEAN, "3");
        table.add(33, 33.3f, -33.3, true);
        table.addColumn(RealmType.STRING, "4");
        table.add(44, 44.4f, -44.4, true, "44");
        table.addColumn(RealmType.DATE, "5");
        Date date = new Date();
        table.add(55, 55.5f, -55.5, false, "55", date);
        table.addColumn(RealmType.BINARY, "6");
        table.add(66, 66.6f, -66.6, false, "66", date, new byte[]{6});
        table.addColumn(RealmType.MIXED, "7");
        table.add(77, 77.7f, -77.7, true, "77", date, new byte[]{7, 7}, "mix");
        table.addColumn(RealmType.TABLE, "8");
    ...
    public void testShouldThrowOnUpdateFromTableSpecOnSubtable() {
        ...
        spec.addColumn(RealmType.INTEGER, "foo");
