...
public class JNIMixedSubtableTest extends TestCase {
    ...
    public void testGetSubtableFromMixedColumnTest() {
        ...
        table.addColumn(RealmType.INTEGER, "num");
        ...
        table.setMixed(1, 0, new Mixed(RealmType.TABLE));
    ...
    public void testShouldCreateSubtableInMixedTypeColumn() {
        ...
        tableSpec.addColumn(RealmType.INTEGER, "num");
        ...
        table.addEmptyRow();
        table.setMixed(1, ROW, new Mixed(RealmType.TABLE));
        ...
        subspecMixed.addColumn(RealmType.INTEGER, "num");
