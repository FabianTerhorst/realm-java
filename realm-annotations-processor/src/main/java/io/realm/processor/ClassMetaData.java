        ...
        for (Element element : classType.getEnclosedElements()) {
            ...
            if (elementKind.equals(ElementKind.FIELD)) {
                ...
                if (variableElement.getAnnotation(Index.class) != null) {
                    ...
                    if (columnType != null && (columnType.equals("RealmType.STRING") ||
                            columnType.equals("RealmType.DATE") ||
                            columnType.equals("RealmType.INTEGER") ||
                            columnType.equals("RealmType.BOOLEAN"))) {
